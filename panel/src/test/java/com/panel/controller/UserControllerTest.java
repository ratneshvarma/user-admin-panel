...
public class UserControllerTest {
	...
	public void allUsers() throws Exception {
		...
		requestBuilder = MockMvcRequestBuilders.get("/api/users").accept(MediaType.APPLICATION_JSON);
		// .content(content_sc);
	...
	public void getUserById() throws Exception {
		...
		requestBuilder = MockMvcRequestBuilders.get("/api/users/" + id).accept(MediaType.APPLICATION_JSON);
		// .content(content_sc);
		result = mvc.perform(requestBuilder).andReturn();
		Gson gson = new Gson();
		ResponseData responseData = gson.fromJson(result.getResponse().getContentAsString(), ResponseData.class);
	...
	public void updateUser() throws Exception {
		...
		requestBuilder = MockMvcRequestBuilders.put("/api/users/").accept(MediaType.APPLICATION_JSON)
				.content(content_sc).contentType(MediaType.APPLICATION_JSON);
		result = mvc.perform(requestBuilder).andReturn();
	...
	public void deleteUser() throws Exception {
		...
		//
		when(userService.exist(anyLong())).thenReturn(false);
		requestBuilder = MockMvcRequestBuilders.delete("/api/users/" + id).accept(MediaType.APPLICATION_JSON);
		result = mvc.perform(requestBuilder).andReturn();
		responseData = gson.fromJson(result.getResponse().getContentAsString(), ResponseData.class);
		assertEquals(responseData.getCode().intValue(), 404);
		assertEquals(result.getResponse().getContentType(), "application/json;charset=UTF-8");
